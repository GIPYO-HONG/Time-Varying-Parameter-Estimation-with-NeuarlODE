...
class Experiment(BaseExperiment):
    ...
    def __init__(self, model_cls, y0, param, ts, ys, norm_scale, hidden_dim=8, width_size=32, depth=4, **kwargs):
    ...
    def plotting(self, ts_eval, loss_list=None):
        ys_pred, k_pred = self.eval(ts_eval)
        ...
        axs[1][1].plot(ts_eval, k_pred, label="Pred k", linestyle="--")
