...
class Experiment(BaseExperiment):
    ...
    def __init__(self, model_cls, ts, ys, hidden_dim=16, width_size=64, depth=4, **kwargs):
        ...
        super().__init__(model, ts, ys, base_dir = "SEIRS/results", **kwargs)
    ...
    def plotting(self, ts_eval, loss_list=None):
        ...
        axs[0].plot(self.ts, self.ys, ".", label="True I")
